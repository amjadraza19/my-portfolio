...
import { ExperienceInfo } from "../CommonInfo";
...
const TimelineItem = (items: any) => {
    ...
    return items.map((item: any, index: number) => <Timeline.Item data-aos="fade-up" data-aos-duration="1000"
...
const Experience = () => {
    ...
    return <div className="px-16 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Experience">
        <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl  mb-10 font-bold text-center text-white">Experience</h1>
