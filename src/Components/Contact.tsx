...
import { IconArrowRight, IconTopologyStar3, IconTopologyStarRing3 } from "@tabler/icons-react";
...
const Contact = () => {
    ...
    return <div className="px-16 md-mx:px-8 sm-mx:px-4 mx-20 lg-mx:mx-10 md-mx:mx-0 my-10  font-mono" id="Contact">
        ...
        <div data-aos="flip-left" data-aos-duration="800" className="w-[70%] lg-mx:w-full shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-primaryColor p-8 rounded-3xl sm-mx:p-4">
            <div className=" text-3xl flex gap-2 items-center text-white font-semibold sm-mx:text-2xl xs-mx:text-xl">Get In Touch<IconTopologyStarRing3 className="w-10 text-primaryColor h-10 sm-mx:w-7 sm-mx:h-7" /></div>
